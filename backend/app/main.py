...
from app.api import admin, attack_chains, auth, chat, detect, events, health, mcp, reports, ws
...
for module in (health, auth, detect, events, reports, mcp, chat, attack_chains, admin):
