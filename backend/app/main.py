...
from app.api import admin, attack_chains, auth, chat, compliance, detect, events, health, mcp, reports, ws
...
for module in (health, auth, detect, events, reports, compliance, mcp, chat, attack_chains, admin):
